...
import tipl.tools.BaseTIPLPluginMult;
...
public class IJPluginRunner extends BaseTIPLPluginMult {
	...
	public IJPluginRunner(final Object theFilter, final TImgRO inAim) {
		SetupImage(inAim);
	...
	protected void SetupImage(final TImgRO inAim) {

		ipImg = TImgToImagePlus.MakeImagePlus(inAim);
	}
